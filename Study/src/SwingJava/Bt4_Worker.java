...
public class Bt4_Worker extends Bt1_Person implements payTax {
	...
	public Bt4_Worker(String name, int citizenID, int phone, String email, Double salary, Double other_income) {
	...
	public static void main(String[] args) {
		...
		Bt4_Worker P1 = new Bt4_Worker(name, citizenID, phone, email, salary, other_income);
		P1.enter();
		P1.display();
	}
