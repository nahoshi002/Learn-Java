...
public class Bt5_BusinessPerson extends Bt1_Person implements payTax{
	// Thuoc tinh
	...
	public Bt5_BusinessPerson(String name, int citizenID, int phone, String email, Double salary,
			Double business_income, Double other_income) {
	...
	public static void main(String[] args) {
		...
		Bt5_BusinessPerson P1 = new Bt5_BusinessPerson(name, citizenID, phone, email, salary, business_income,
				other_income);
		P1.enter();
		P1.display();
	}
